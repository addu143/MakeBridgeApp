...
<head>
    ...
    <div id="fontColorDialog" style="display: none;">
        <div id="CustomColorPicker">
            <label><p class="grey-col"> Selected color</p> </label>
            <input type="text" class="selectedFontColor acco-input" size="15" maxlength="15" readonly />
            <label><p class="grey-col background"> Pick a color</p> </label>
    ...
    <div class="wrapper">
        <div class="navbar">
            <ul>
                ...
                <li class="save"><a class="MenuCallBackSave" href="#">Save</a></li>
            ...
            <div id="tabs">
                ...
                <div id="tabs-1">
                    <div class="accordion">
                        ...
                        <h3 class="my-build-blocks accordian-common">My Building Blocks</h3>
                        <div style="padding: 10px;">
						
						<div class="imagelib-icons-building">
                            <a href="#" class="editBB"><img title="tooltip-lorem ipsum" alt="" src="images/ico-edit.png" style="width:24px;" /></a>
                            <a href="#" class="deleteBB"><img title="tooltip-lorem ipsum" alt="" style="width:28px;" src="images/delete-ico.png" /></a>
</div>
                        ...
                        <div>
							...
							<div class="imagelib-icons-dynamic">
                                <a href="#" class="editDBB"><img title="tooltip-lorem ipsum" alt="" src="images/ico-edit.png" style="width:24px;" /></a>
                                <a href="#" class="deleteDBB"><img title="tooltip-lorem ipsum" alt="" style="width:28px;" src="images/delete-ico.png" /></a>
                            </div>
                            ...
                            <div style="height: 350px;">
                                ...
                                <h4 class="no-margin font_75 grey-col">New</h4>
                                <ul class="b-blocks">
                                    <li class="draggableControl" data-type="dynamicContentContainer" data-isnew='true'>
                                        <img title="Dynamic Content Container" alt="" src="images/1col-ico.png" /><br />
                                        <a href="#"><span class=" font_75">Dynamic </span></a></li>
                                </ul>
                                ...
                                <div class='dynamicBlockDroppable'>    
                                    <h4 class="no-margin font_75 grey-col">Existing</h4>
...
<a href="#"><img title="tooltip-lorem ipsum" alt="" style="width:28px;" src="images/delete-ico.png" /></a>
                ...
                <div id="tabs-2">
                    <div class="accordion">
                        <h3 class="background-accordion accordion2-common">Background Color</h3>
                        <div class="no-margin padding-10">
                            <div style="height: 350px;">
                                <form class="back-form" action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="button" class="acco-button addToMyColors" value="ADD TO MY COLORS" style='float:right; margin:0;' />
...
<div class="buildingBlock_name_edit" style="display: none;">
        ...
        <div class="dynamicBuildingBlock_name_edit" style="display: none;">
            <div class="ddgwin-titlebar">
                <span class="ddgwin-title">Edit Dynamic building block name</span>
            </div>
            <div style="height: 106px;">
                <br>
                <div style="width: 250px;">
                    ...
                    <div>
                        <input type="text" class='txtPlaceHolder editdynamicBlockInputName' placeholder="Provide a name for your building block"
                            style="width: 430px;" maxlength="255">
                    </div>
                </div>
                <div style="font-size: 12px;">
        ...
        <div class="dcRuleTemplate" style='display:none;'>
         <li class="listing rule">
                <ul class="clearfix">
                    <li>
                        <select name="dcfn" class="dcRuleFieldName">
                    ...
                    <li>
                        <select name="dcc" class="dcRuleCondition">
                               <option value="==">==</option>
                            <option value="!=">!=</option>
                            <option value=">">></option>
                            <option value="<"><</option>
                    ...
                    <li>
                        <select name="dcf" class="dcRuleFormat">
                    ...
                    <li>
                        <input type="text" class="dcRuleMatchValue" />
                    </li> 
        ...
        <div class='dcRulesDialog' style='display:none;'> 
               <div class="block_body_inner">
            
            
                
                    <div> 
                        <input type="text" class="dcRuleLabel" />
                    </div>
                    <div class="rules_matches">
                        if&nbsp;<a href="javascript:void(0);" class="all toggle_btn">All</a><a href="javascript:void(0);" class="any toggle_btn">Any</a>&nbsp;rule(s) matches
                    </div>
                
                    <ul class="dynamic_inputs_list clearfix">
        ...
        <div style="display:none;" id="dcRuleRow"> 
         <li class="listing rule">
				<ul class="clearfix">
					<li>
						<select name="dsf" class="dcRuleFieldName">
							<option value="FirstName">First Name</option>
							<option value="LastName">Last Name</option>
							<option value="Gender">Gender</option>
					...
					<li>
						<select name="dsf" class="dcRuleCondition">
							<option value="==">==</option>
							<option value="!=">!=</option>
							<option value=">">></option>
                            <option value="<"><</option>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            // var _preDefinedHTML = "<ul class=\"sortable mainContentHtml\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table class=\"container\"><tbody><tr><td style=\"width: 50%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_81\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text First column</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td><td style=\"width: 50%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_82\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text second column</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table class=\"container\"><tbody><tr><td style=\"width: 33.333333333333336%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"\"><div class=\"myImage\"><div class=\"ui-wrapper\" style=\"overflow: hidden; width: 200px; height: 200px;\"><img style=\"height: 200px; width: 200px; margin: 0px; resize: none; position: static; zoom: 1; display: block;\" class=\"imageHandlingClass resizable clickEvent ui-resizable\" src=\"http://dnfnb6d6ypvmf.cloudfront.net/pms/graphics/I54XHXtG/thumbs/114.png\"><div class=\"ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se\" style=\"z-index: 90; display: block;\"></div><div class=\"ui-resizable-handle ui-resizable-sw\" style=\"z-index: 90; display: block;\"></div></div></div></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td><td style=\"width: 33.333333333333336%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_83\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text Middle column</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li></ul></td><td style=\"width: 33.333333333333336%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"\"><div class=\"myImage\"><div class=\"ui-wrapper\" style=\"overflow: hidden; width: 200px; height: 200px;\"><img style=\"height: 200px; width: 200px; margin: 0px; resize: none; position: static; zoom: 1; display: block;\" class=\"imageHandlingClass resizable clickEvent ui-resizable\" src=\"http://dnfnb6d6ypvmf.cloudfront.net/pms/graphics/I54XHXtG/thumbs/120.png\"><div class=\"ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se\" style=\"z-index: 90; display: block;\"></div><div class=\"ui-resizable-handle ui-resizable-sw\" style=\"z-index: 90; display: block;\"></div></div></div></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table class=\"container\"><tbody><tr><td style=\"width: 25%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_84\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text col 1-4</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li></ul></td><td style=\"width: 25%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_85\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text col 2-4</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li></ul></td><td style=\"width: 25%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"\"><div class=\"myImage\"><div class=\"ui-wrapper\" style=\"overflow: hidden; width: 200px; height: 200px;\"><img style=\"height: 200px; width: 200px; margin: 0px; resize: none; position: static; zoom: 1; display: block;\" class=\"imageHandlingClass resizable clickEvent ui-resizable\" src=\"http://dnfnb6d6ypvmf.cloudfront.net/pms/graphics/I54XHXtG/thumbs/121.png\"><div class=\"ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se\" style=\"z-index: 90; display: block;\"></div><div class=\"ui-resizable-handle ui-resizable-sw\" style=\"z-index: 90; display: block;\"></div></div></div></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td><td style=\"width: 25%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_86\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text col 4-4</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table class=\"container\"><tbody><tr><td style=\"width: 33.333333333333336%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_87\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text col 1-3</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li></ul></td><td style=\"width: 33.333333333333336%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"\"><div class=\"myImage\"><div class=\"ui-wrapper\" style=\"overflow: hidden; width: 200px; height: 200px;\"><img style=\"height: 200px; width: 200px; margin: 0px; resize: none; position: static; zoom: 1; display: block;\" class=\"imageHandlingClass resizable clickEvent ui-resizable\" src=\"http://dnfnb6d6ypvmf.cloudfront.net/pms/graphics/I54XHXtG/thumbs/41.png\"><div class=\"ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se\" style=\"z-index: 90; display: block;\"></div><div class=\"ui-resizable-handle ui-resizable-sw\" style=\"z-index: 90; display: block;\"></div></div></div></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td><td style=\"width: 33.333333333333336%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"textcontent mce-content-body\" id=\"mce_88\" tabindex=\"-1\" contenteditable=\"true\" spellcheck=\"false\" style=\"position: relative;\"><p>This is sample text col 3-3</p></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table class=\"container\"><tbody><tr><td style=\"width: 50%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"\"><div class=\"myImage\"><div class=\"ui-wrapper\" style=\"overflow: hidden; width: 200px; height: 200px;\"><img style=\"height: 200px; width: 200px; margin: 0px; resize: none; position: static; zoom: 1; display: block;\" class=\"imageHandlingClass resizable clickEvent ui-resizable\" src=\"http://dnfnb6d6ypvmf.cloudfront.net/pms/graphics/I54XHXtG/thumbs/colors_apple-wide.jpg\"><div class=\"ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se\" style=\"z-index: 90; display: block;\"></div><div class=\"ui-resizable-handle ui-resizable-sw\" style=\"z-index: 90; display: block;\"></div></div></div></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td><td style=\"width: 50%;\"><ul class=\"sortable\"><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li><li class=\"ui-draggable ui-droppable csHaveData\"><table width=\"100%\"><tbody><tr><td><div class=\"\"><div class=\"myImage\"><div class=\"ui-wrapper\" style=\"overflow: hidden; width: 200px; height: 200px;\"><img style=\"height: 200px; width: 200px; margin: 0px; resize: none; position: static; zoom: 1; display: block;\" class=\"imageHandlingClass resizable clickEvent ui-resizable\" src=\"http://dnfnb6d6ypvmf.cloudfront.net/pms/graphics/I54XHXtG/thumbs/Boston City Flow.jpg\"><div class=\"ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se\" style=\"z-index: 90; display: block;\"></div><div class=\"ui-resizable-handle ui-resizable-sw\" style=\"z-index: 90; display: block;\"></div></div></div></div></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden;\"></li></ul></td></tr></tbody></table></li><li class=\"myDroppable ui-draggable ui-droppable\" style=\"visibility: hidden; background-color: rgb(220, 238, 254);\"></li></ul>";
            ...
            $("#myMakeBridge").MakeBridgeEditor({
                ...
                OnDropElementOnBuildingBlock: function (args) {
                    ...
                    if (args.buildingBlock != null) {
                        ...
                        // var URL = "/pms/io/publish/saveEditorData/?<%=WebSecurityManager.getCSRFToken_HREF(session)%>&type=addBlock&name="+args.buildingBlock.Name +"&html="+args.buildingBlock.Html.html();
                        // $.post(URL, {
                ...
                OnEditBuildingBlock: function (args) {
                    ...
                    if (args.buildingBlock != null) {
                        ...
                        console.log("Block Name:" + args.buildingBlock.Name);
                        // var URL = "/pms/io/publish/saveEditorData/?<%=WebSecurityManager.getCSRFToken_HREF(session)%>&type=renameBlock";
                        // $.post(URL, {
                        ...
                        $.ajax({
                            url: "/pms/io/publish/saveEditorData/?<%=WebSecurityManager.getCSRFToken_HREF(session)%>&type=renameBlock&name="+ args.buildingBlock.Name + "&blockId=" + args.buildingBlock.Id ,
                           //data: "{ name: 'test', html: args.buildingBlock.Name }",
                           type: "POST",
                           contentType: "application/json; charset=latin1",
                           dataType: "json",
                ...
                OnDeleteBuildingBlock: function (args) {
                    if (args != null) {
                     ...
                     $.ajax({
                            url: "/pms/io/publish/saveEditorData/?<%=WebSecurityManager.getCSRFToken_HREF(session)%>&type=deleteBlock&blockId=" + args.buildingBlock.Id ,
                           //data: "{ name: 'test', html: args.buildingBlock.Name }",
                           type: "POST",
                           contentType: "application/json; charset=latin1",
                           dataType: "json",
                ...
                OnEditDynamicVariation: function (args) {
                    ...
                    if (args.dynamicVariation != null) {
                        console.log("Block Id:" + args.dynamicVariation.Id);
                        console.log("Block Name:" + args.dynamicVariation.Name);
                        
                        $.ajax({
                            url: "/pms/io/publish/saveDynamicVariation/?<%=WebSecurityManager.getCSRFToken_HREF(session)%>&type=relabel&label="+ args.dynamicVariation.Name + "&dynamicNumber=" + args.dynamicVariation.Id ,
                           //data: "{ name: 'test', html: args.buildingBlock.Name }",
                           type: "POST",
                           contentType: "application/json; charset=latin1",
                           dataType: "json",
                ...
                OnDeleteDynamicVariation: function (args) {
                    if (args != null) {
                        console.log(args.dynamicVariation.Id);
                    
                     $.ajax({
                            url: "/pms/io/publish/saveDynamicVariation/?<%=WebSecurityManager.getCSRFToken_HREF(session)%>&type=delete&dynamicNumber=" + args.dynamicVariation.Id ,
                           //data: "{ name: 'test', html: args.buildingBlock.Name }",
                           type: "POST",
                           contentType: "application/json; charset=latin1",
                           dataType: "json",
                ...
                OnExistingDynamicControlDropped: function(args)
                {
                    //GET ID
                    console.log("ID in OnExistingDynamicControlDropped:" +args.ID);

                    //FILL HERE
                    //args.DynamicVariation = loadDynamicVariationFromServer("zdTyioBh17Gj20zvfrtg");
