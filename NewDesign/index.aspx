<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MakeBridge.NewDesign.test1" %>
...
<head>
    ...
    <style type="text/css">
        ...
        .chosen-container { width: 165px !important; }
    </style>
...
<div class="tools">
    ...
    <div class="tabcontent builder-panel">
        <div class="accordian">
            <h3 class="active">
                <span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span>Building Blocks
            </h3>
                ...
                <div class="accordianbar">
                    <div>
                        <div class="search" style="width: 240px;">
                            <input type="text" value="" name="" style="width: 220px;" id="searchBB" />
            ...
            <div class="accordian-content active">
                <div class="accordianbar">
                    <div>
                        <h5></h5>
                        <div class="search" style="width:240px;">
                            <input type="text" value="" name="" style="width:220px;" id="searchDC"/>
            ...
            <h3>
                <span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span>Image Library
            </h3>
            <div class="accordian-content active">
                <div class="accordianbar">
                    <div class="" style="display: ;">
                        ...
                        <form id="form1" enctype="multipart/form-data" action="/pms/io/publish/saveImagesData/?<h4>Cross-browser compatibility</h4>&type=add" method="POST">
                ...
                <div class="clearfix">
                    ...
                    <div style="padding:5px;">
                        ...
                        <div class="styletable clearfix">
                            ...
                            <div class="stylebox">
                                ...
                                <div class="ddg-control ved-edges ddg-container borderControl" style=" top: 39px;">
                                    <div unselectable="on" id="top" class="ddg-control ddg-button ved-edges-button ved-edges-top ddg-unselectable" >
                        ...
                        <div class="clearfix" style="padding:0;">
                            ...
                            <ul class="aligncol">
                                <li id="Li1" class="sVerticalAlign active">
                                ...
                                <li id="Li2" class="sVerticalAlign" >
            ...
            <div class="accordian-content active ">
                ...
                <div class="clearfix">
                    ...
                    <div style="padding:5px;">
                        ...
                        <input type="text" class="txtColorCode txtContainerSize acco-input " size="15" maxlength="15"> pixels
                    </div>
                </div>
...
<!--  editorpanel  -->
<div class="ui-widget-overlay ui-front modalDialog" style="display:none;"></div>
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons" id="ColorPickerpop" style="height: auto;  z-index: 99999;width: 300px; top:254px; left: 566px; display: none;" tabindex="-1" role="dialog" aria-describedby="fontColorDialog" aria-labelledby="ui-id-8">
    ...
    <div style="width: auto; min-height: 0px; max-height: none; height: 305px; " id="fontColorDialog" class="ui-dialog-content ui-widget-content">
        <div id="CustomColorPicker">
            ...
            <div class="mycolorFontPicker clearfix" style="margin-top: -20px; padding-left:10px;">
                <label>
                             ...
                             <div class="filter-row rule">
                                ...
                                <select data-placeholder="Choose a Field" class="forms-box chosen-select firstChosen chosefields dcRuleFieldName" style="width:224px;">
                                  ...
                                  <select class="nosearch conddd secondChosen dcRuleCondition" style="width:180px">
                                      ...
                                      <option>Within date range</option>
                                      <option>Within numeric range</option>
                                      <option>Day(s) prior</option>
		...
		<script type="text/javascript">
		    ...
		    $(document).ready(function () {
		        ...
		        var _imageAjaxParameters = {
		            Url: "/pms/io/publish/getImagesData/?&type=list&offset=0",
			    Data: "",
			    DataType: "",
			    Type: "",
			    ContentType: ""
			    ...
			    var _AddimageAjaxParameters = {
			        Url: "/pms/io/publish/saveImagesData/?&type=add",
			    Data: "",
			    DataType: "",
			    Type: "",
			    ContentType: ""
			    ...
			    var _searchImagesAjaxParameters = {
			        Url: "/pms/io/publish/getImagesData/?&type=search&offset=0&searchText=",
			    Data: "",
			    DataType: "",
			    Type: "",
			    ContentType: ""
			    ...
			    var _saveImageTagsAjaxParameters = {
			        Url: "/pms/io/publish/saveImagesData/?&type=tags&imageId=",
			    Data: "",
			    DataType: "",
			    Type: "",
			    ContentType: ""
			    ...
			    var _deleteImageAjaxParameter = {
			        Url: "/pms/io/publish/saveImagesData/?&type=delete&imageId=",
			    Data: "",
			    DataType: "",
			    Type: "",
			    ContentType: ""
			    ...
			    $("#myMakeBridge").MakeBridgeEditor({
			        ...
			        OnDropElementOnBuildingBlock: function (args) {
			            ...
			            if (args.buildingBlock != null) {
			                ...
			                $.ajax({
			                    url: "/pms/io/publish/saveEditorData/?&type=addBlock&name=" + args.buildingBlock.Name + "&html=" + encodeURIComponent(args.buildingBlock.Html.html()),
				    ...
				    LoadBuildingBlocks: function (args) {
				        ...
				        $.ajax({
				            url: "/pms/io/publish/getEditorData/?&type=listBlocks",
					    data: "{}",
					    type: "POST",
				    ...
				    OnEditBuildingBlock: function (args) {
				        ...
				        if (args.buildingBlock != null) {
				            ...
				            $.ajax({
				                url: "/pms/io/publish/saveEditorData/?&type=renameBlock&name=" + args.BlockName + "&blockId=" + args.BlockID,
				                //data: "{ name: 'test', html: args.buildingBlock.Name }",
				                type: "POST",
				                contentType: "application/json; charset=latin1",
				                dataType: "json",
				    ...
				    OnDeleteBuildingBlock: function (args) {
				        if (args != null) {
				            ...
				            $.ajax({
				                url: "/pms/io/publish/saveEditorData/?&type=deleteBlock&blockId=" + args.BlockID,
				                //data: "{ name: 'test', html: args.buildingBlock.Name }",
				                type: "POST",
				                contentType: "application/json; charset=latin1",
				                dataType: "json",
				    ...
				    LoadMyColors: function (args) {
				        ...
				        $.ajax({
				            url: "/pms/io/publish/getEditorData/?&type=listColors",
						    data: "{}",
						    type: "POST",
						    contentType: "application/json; charset=latin1",
						    dataType: "json",
				    ...
				    OnColorAdded: function (args) {
				        ...
				        var URL = "/pms/io/publish/saveEditorData/?&type=saveColors&colors=" + saveColors;
						$.post(URL)
						.done(function (data) {
				    ...
				    OnSaveDynamicContent: function (args) {
				        ...
				        var contentURL = "/pms/io/publish/saveDynamicVariation/?&type=newContent&dynamicNumber=" + dynamicNumber + "&campaignSubject=" + content.Label + "&contents=" + encodeURIComponent(content.InternalContents) + "&contentLabel=" + content.Label + "&isDefault=" + (content.IsDefault ? "Y" : "N");
                        $.ajax({
                            url: contentURL,
                            //data: "{ name: 'test', html: args.buildingBlock.Name }",
                            type: "POST",
				    ...
				    OnSaveDynamicRules: function (args) {
				        ...
				        var contentRuleURL = "/pms/io/publish/saveDynamicVariation/?&type=updateContentRules&dynamicNumber=" + dynamicNumber + "&contentNumber=" + dynamicNumberContent + "&applyRuleCount=" + content.ApplyRuleCount + "&ruleCount=" + rules.length;
				    ...
				    OnUpdateDynamicContent: function (args) {
				        ...
				        var contentURL = "/pms/io/publish/saveDynamicVariation/?&type=updateContent&dynamicNumber=" + dynamicNumber + "&campaignSubject=" + content.Label + "&contents=" + encodeURIComponent(content.InternalContents) + "&contentLabel=" + content.Label + "&contentNumber=" + dynamicNumberContent;
				    ...
				    OnDeleteDynamicContent: function (args) {
				        ...
				        var contentURL = "/pms/io/publish/saveDynamicVariation/?&type=deleteContent&dynamicNumber=" + dynamicNumber + "&contentNumber=" + dynamicNumberContent;
				    ...
				    OnDynamicControlSave: function (variation) {
				        ...
				        if (variation.IsUpdate) {
				            ...
				            $.ajax({
				                url: "/pms/io/publish/saveDynamicVariation/?&type=relabel&label=" + variation.Label + "&dynamicNumber=" + variation.DynamicVariationID,
                                //data: "{ name: 'test', html: args.buildingBlock.Name }",
                                type: "POST",
                                contentType: "application/json; charset=latin1",
                                dataType: "json",
                            ...
                            for (var i = 0; i < contents.length; i++) {
                                ...
                                var contentURL = "";
                                if (contentNumber != 0) {
                                    contentURL = "/pms/io/publish/saveDynamicVariation/?&type=updateContent&dynamicNumber=" + dynamicNumber + "&campaignSubject=" + content.Label + "&contents=" + encodeURIComponent(content.InternalContents) + "&contentLabel=" + content.Label + "&contentNumber=" + contentNumber;
                                }
                                else {
                                    contentURL = "/pms/io/publish/saveDynamicVariation/?&type=newContent&dynamicNumber=" + dynamicNumber + "&campaignSubject=" + content.Label + "&contents=&contentLabel=" + content.Label + "&isDefault=" + (content.IsDefault ? "Y" : "N");
                                }
                                ...
                                $.ajax({
                                    ...
                                    success: function (ec) {
                                        ...
                                        var rules = content.ListOfDynamicRules;
                                        var contentRuleURL = "/pms/io/publish/saveDynamicVariation/?&type=updateContentRules&dynamicNumber=" + dynamicNumber + "&contentNumber=" + contentNumber + "&applyRuleCount=" + content.ApplyRuleCount + "&ruleCount=" + rules.length;
                                        for (var j = 0; j < rules.length; j++) {
                                            var rule = rules[j];
                                            //contentRuleURL += "&"+ j +".spanInDays=";
                                            contentRuleURL += "&" + (j + 1) + ".matchValue=" + rule.RuleMatchValue;
                            ...
                            var URL = "/pms/io/publish/saveDynamicVariation/?&type=new&contentType=H&label=" + variation.Label;
				    ...
				    OnEditDynamicVariation: function (args) {
				        ...
				        if (args.DCID != null) {
				            ...
				            $.ajax({
				                url: "/pms/io/publish/saveDynamicVariation/?&type=relabel&label=" + args.DCName + "&dynamicNumber=" + args.DCID,
                                //data: "{ name: 'test', html: args.buildingBlock.Name }",
                                type: "POST",
                                contentType: "application/json; charset=latin1",
                                dataType: "json",
				    ...
				    OnDeleteDynamicVariation: function (args) {
				        if (args != null) {
				            ...
				            $.ajax({
				                url: "/pms/io/publish/saveDynamicVariation/?&type=delete&dynamicNumber=" + args.DCID,
                             //data: "{ name: 'test', html: args.buildingBlock.Name }",
                             type: "POST",
                             contentType: "application/json; charset=latin1",
                             dataType: "json",
				    ...
				    LoadDynamicBlocks: function (args) {
				        ...
				        $.ajax({
				            url: "/pms/io/publish/getDynamicVariation/?&type=list",
						    data: "{}",
						    type: "POST",
						    contentType: "application/json; charset=latin1",
						    dataType: "json",
				    ...
				    LoadDynamicBlockFields: function (args) {
				        ...
				        $.ajax({
				            url: "/pms/io/getMetaData/?&type=fields_all",
						    data: "{}",
						    type: "POST",
						    contentType: "application/json; charset=latin1",
						    dataType: "json",
				    ...
				    LoadDynamicBlockRuleConditions: function (args) {
				        ...
				        $.ajax({
				            url: "/pms/io/getMetaData/?&type=rules",
						    data: "{}",
						    type: "POST",
						    contentType: "application/json; charset=latin1",
						    dataType: "json",
				    ...
				    LoadDynamicBlockFormats: function (args) {
				        ...
				        $.ajax({
				            url: "/pms/io/getMetaData/?&type=formats",
						    data: "{}",
						    type: "POST",
						    contentType: "application/json; charset=latin1",
						    dataType: "json",
				    ...
				    LoadPersonalizeTags: function (args) {
				        ...
				        $.ajax({
				            url: "/pms/io/getMetaData/?&type=merge_tags",
						    data: "{}",
						    type: "POST",
						    contentType: "application/json; charset=latin1",
						    dataType: "json",
...
<script type="text/javascript">
    ...
    function applyborder(border_of) {
        ...
        //console.log("apply border called");
        ...
        if (border_of == "topNone") {
            $element.css("border-top", "none");
            $(".borderControl #top").removeClass('borderselected');
            return;
        }
        if (border_of == "bottomNone") {
            $element.css("border-bottom", "none");
            $(".borderControl #bottom").removeClass('borderselected');
            return;
        }
        if (border_of == "leftNone") {
            $element.css("border-left", "none");
            $(".borderControl #left").removeClass('borderselected');
            return;
        }
        if (border_of == "rightNone") {
            $element.css("border-right", "none");
            $(".borderControl #right").removeClass('borderselected');
            return;
        }
        ...
        if (border_of == "top") {
            ...
            if (is_bordery_applied[0] == 0) {
                ...
                $(".borderControl #top").addClass('borderselected');
                //$(".borderControl #top .sBorderLine").addClass('active');
                ...
                $(".borderControl #top").removeClass('borderselected');
                //$(".borderControl #top .sBorderLine").removeClass('active');
        ...
        if (border_of == "bottom") {
            ...
            if (is_bordery_applied[0] == 0) {
                ...
                $(".borderControl #bottom").addClass('borderselected');
                //$(".borderControl #bottom .sBorderLine").addClass('active');
                ...
                $(".borderControl #bottom").removeClass('borderselected');
                //$(".borderControl #bottom .sBorderLine").removeClass('active');
        ...
        if (border_of == "left") {
            ...
            if (is_bordery_applied[0] == 0) {
                ...
                $(".borderControl #left").addClass('borderselected');
                //$(".borderControl #left .sBorderLine").addClass('active');
                ...
                //$(".borderControl #left .sBorderLine").removeClass('active');
                $(".borderControl #left").removeClass('borderselected');
        ...
        if (border_of == "right") {
            ...
            if (is_bordery_applied[0] == 0) {
                ...
                $element.css("width", 48 - TotalBorderLeftRight + "px");
                //$(".borderControl #right .sBorderLine").addClass('active');
                $(".borderControl #right").addClass('borderselected');
                ...
                $element.css("width", box_width + borderBottomWidth + "px");
                $(".borderControl #right").removeClass('borderselected');
                //$(".borderControl #right .sBorderLine").removeClass('active');
