...
<head>
  ...
  <div class="modal in" style="width: 780px; margin-left: -380px;" aria-hidden="false">
	...
	<div class="camp_header grayicons ">
		...
		<li><a title="" class="icon close showtooltip closeIconLinkGui" data-original-title="Close"></a></li>
	</ul>
			...
			<div class="accordian">
				...
				<div class="accordian-content ">
					...
					<div class="clearfix">
					  <h4 class="">Spacer</h4>
					  <ul class="b-blocks">
						<li class="draggableControl ui-draggable" data-type="spacer5"> <i class="icon spacer1"></i> <a href="#"><span class=" font_75">Spacer 1</span></a></li>
						<li class="draggableControl ui-draggable" data-type="spacer10"> <i class="icon spacer2"></i> <a href="#"><span class=" font_75">Spacer 2</span></a></li>
						<li class="draggableControl ui-draggable" data-type="spacer15"> <i class="icon spacer3"></i> <a href="#"><span class=" font_75">Spacer 3</span></a></li>
						<li class="draggableControl ui-draggable" data-type="spacer20"> <i class="icon spacer4"></i> <a href="#"><span class=" font_75">Spacer 4</span></a></li>
					  </ul>
					</div>
				</div>
				<!--  accordian-content  -->
					...
					<div class="accordianbar">
						<div>
							...
							<div class="image-info" style="left: 199px; top: 33px;">
                                ...
                                <a class="btn-green left MenuCallBackSave" style="display: none;"><span>Save</span><i class="icon save"></i></a>
	...
	<div class="tabcontent style-panel" style="display: none;">
		<div class="accordian">
			...
			<h3 class=""> <span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span>Background Color </h3>
			<div class="accordian-content ">
				...
				<div style="padding:5px;">
					...
					<div class="styletable clearfix">
								...
								<div class="stylebox">
											...
											<div class="minicolors minicolors-theme-default minicolors-position-top minicolors-position-left"><a class="fl colorPickerBorder acco-label minicolors-input" href="#"></a></div>
								...
								<div class="clearfix" style="padding:0;">
									...
									<ul class="aligncol">
                                        <li id="top" class="sVerticalAlign active"><a href="#." onclick="applyAlignment('top')";><i class=" icon aligntop" data-type="Top"></i>Top</a></li>
                                        <li id="middle" class="sVerticalAlign" ><a href="#." onclick="applyAlignment('middle');"><i class="icon alignmiddle" data-type="Middle"></i>Middle</a></li>
                                        <li id="bottom" class="sVerticalAlign" ><a href="#." onclick="applyAlignment('bottom');"><i class="icon alignbottom" data-type="Bottom"></i>Bottom</a></li>
									</ul>
								</div>
  ...
  <!--  tabcontent  --> 
	...
	<div class="editorpanel">
		<div class="editorbar">
			<ul>
                ...
                <li class="MenuCallPreview"><a href="#" class="btn-blue"><i class="icon preview"></i><span>Preview</span></a></li>
                <li class="save MenuCallBackSave"><a href="#" class="btn-green "><i class="icon save"></i><span>Save</span></a></li>
			</ul>
		</div>
		<!--  tools  -->
    ...
    <div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons" id="ColorPickerpop" style="height: auto;  z-index: 99999;width: 300px; top:254px; left: 566px; display: none;" tabindex="-1" role="dialog" aria-describedby="fontColorDialog" aria-labelledby="ui-id-8">
		<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix" style="display:none;"><span id="ui-id-8" class="ui-dialog-title">Font Color Picker</span>
        ...
        <div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
            <div class="ui-dialog-buttonset">
              ...
              <button type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only btn-gray" role="button" aria-disabled="false" id="fontDialogCancelButtonID"><span class="ui-button-text">Close</span></button>
              <button type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false" id="fontDialogOKButtonID"><span class="ui-button-text">OK</span></button>
            </div>
        </div>
		</div>
        ...
        <div class="modal in" style="width: 518px; margin-left: -260px;" aria-hidden="false">
            <div class="modal-header ws-notags">
                <div class="camp_header grayicons ">
                    ...
                    <ul class="toolbar imgPreviewtoolbar">
                        <li>
                            <!--<a  class="icon more showtooltip" title="More"></a>-->
                            <ul id="more-tool-actions">
                                <li class=""><a title="" class="icon newwin showtooltip imgPreviewtoolbar-action" data-original-title="Open in new window" data-action="NewWindow" data-imgurl=""></a></li>
                            </ul>
                        </li>
                        <li><a title="" class="icon close showtooltip imgPreviewtoolbar-action" data-original-title="Close" data-action="CloseWindow"></a></li>
                    </ul>
                </div>
            </div>
            <div class="modal-body" style="min-height: 260px;">
    ...
    <div>
        <div class="divPreviewCode" > </div>
        <div class="divHtmlCode" > </div>
    </div>
		</script>
