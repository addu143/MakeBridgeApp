    ...
    <div class="tabcontent builder-panel">
        <div class="accordian">
            ...
            <div class="accordian-content active">
                ...
                <div class="clearfix">
                    <ul class="b-blocks">
                        <li class="draggableControl ui-draggable newblock" data-type="dynamicContentContainer">
                            <i class="icon plus"></i>
                            <a href="#">
...
<div class="divDCTemplate" style="display:none;">
    ...
    <table class="container dynamicContentContainer" id="0">
        <tbody>
            <tr>
                <td>
...
<div class="rulesdiv dcRulesDialog" style="display:none;">
    <div>
        ...
        <div class="filter-div">
            ...
            <div class="match filter_start">
                If
                <div class="btn-group all-any" data-toggle="buttons-radio">
                    <button class="btn active" rule="A">All</button>
                    <button class="btn" rule="1">Any</button>
                </div>rule(s) matches
            </div>
            ...
            <div class="filter-row filter-menu addfilter">
                <a class="btn-green" href="javascript:addNewRule();">
                    <i class="icon plus"></i>
                </a>
            </div> <!-- filter-menu -->
...
<div style="display:none;" class="dcRuleRowTemplate">
    <li class="listing rule">
        <ul class="clearfix">
            ...
            <li>
                <input type="text" class="dcRuleMatchValue" style="height:16px;" />
            </li>
...
<div class="dcLI" style="display:none;">
    <li>
        ...
        <div class="moredd" style="display:none;">
            <ul>
                <li>
...
/*
	...
	function addNewRule() {
        ...
        var html = $(".dcRuleRowTemplate").html();
