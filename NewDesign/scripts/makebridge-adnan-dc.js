...
$.fn.extend({
    ...
    MakeBridgeEditor: function (options) {
        ...
        $(".undo1").click(function () {
            ...
            var newHtml = undoManager.undo(mainContentHtmlGrand.html());
            if (newHtml != "false") {

                var oNewHtml = $(newHtml);
                mainContentHtmlGrand.html(oNewHtml);
                ...
                // args.predefinedControl = new Object();
                // args.predefinedControl.Html = mainContentHtmlGrand;
                ...
                // ReInitializeDragDropHoverAll(args.predefinedControl.Html);
        ...
        var PopulateContent = function (args)
        {
            if (args.DynamicVariation != null) {
                ...
                $.each(args.DynamicVariation.ListOfDynamicContents, function (i, variation) {
                    ...
                    ContentLi.data("dcInternalData", $(variation.InternalContents));
                    ...
                    if(variation.Label == "Default") {
                        ...
                        var defaultInternalContent = $(variation.InternalContents);
                        oInitDestroyEvents.InitAll(defaultInternalContent);
                        dcInternal.html(defaultInternalContent);
                        
                        
                        // args.predefinedControl.Html = dcInternalContents;
                        // args.droppedElement = args.predefinedControl.Html;
                        
                        //InitializeAllEvents(args);
                        //ReInitializeDragDropHoverAll(dcInternalContents);
                    }
        ...
        var PopulateRulesWindow = function (args) {
            if (args.DynamicContent != null) {
                ...
                //console.log("Internal Contents of Dynamic content:" + args.DynamicContent.internalContents);
                //console.log("Pervious Internal Contents of Dynamic content:" + dcInternalContents.html());

                //dcInternalContents.empty();
                //var decodeHTML = $('<div/>').html(args.DynamicContent.internalContents);
                // dcInternalContents.html(decodeHTML);
                // dcInternalContents.html(args.DynamicContent.internalContents);
                // args.predefinedControl.Html = dcInternalContents;
                // args.droppedElement = args.predefinedControl.Html;
                // InitializeAllEvents(args);
                oInitDestroyEvents.InitAll(dcInternalContents);
        ...
        var InitializeDynamicControl = function (args)
        {
            if (args.predefinedControl != null) {
                    ...
                    else
                    {
                        ...
                        args.predefinedControl.Html.find(".dcContents li").each(function (i, o) {
                            ...
                            if (obj.hasClass("active")) {
                                ...
                                dContent.InternalContents = dcInternal.outerHTML();
                            ...
                            {
                                dContent.InternalContents = obj.data("dcInternalData").outerHTML();
                                alert(obj.data("dcInternalData").outerHTML());
                            }

                            

                            variation.ListOfDynamicContents.push(obj);
                        });
                ...
                args.predefinedControl.Html.find(".dcContents").on("click", "li", (function () { //&&
                    ...
                    //    dcInternal.html(internalData.html());
                    //}
                    //else {
                    //    dcInternal.empty();
                    //}
                    ...
                    //    dcClickedContainer.find("li.active:first").data("dcInternalData", dcInternal);
                    //}

                    //alert(args.clickedLi.data("dcInternalData").outerHTML());

                    //args.clickedLi.siblings().css( "background-color", "#82b8cc" );
                    //args.clickedLi.css('background-color','#748EA2');
