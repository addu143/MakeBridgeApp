...
function attachLinkWithElement(workingObject, linkHtmlPage) {    
...
function getImagesMarkup(obj) {
    ...
    $.each(obj[0], function(index, val) {     
        ...
        var li = "<li class='draggableControl ui-draggable droppedImage' data-type='droppedImage'>";
            ...
            li += "<i class='imgicons info action' data-actiontype='imageInfo' data-id='" + val[0]["imageId.encode"] + "'></i>";
            li += "<i class='imgicons link action' data-actiontype='imageLink' data-id='" + val[0]["imageId.encode"] + "'></i>";
            li += "<i class='imgicons preview action' data-actiontype='imagePreview' data-id='" + val[0]["imageId.encode"] + "' data-url='" + val[0].originalURL + "' data-name='" + val[0].fileName + "'></i>";
            li += "<i class='imgicons tag action' data-actiontype='imageTag' data-id='" + val[0]["imageId.encode"] + "'></i>";
            li += "<i class='imgicons delete action' data-actiontype='imageDelete' data-id='" + val[0]["imageId.encode"] + "'></i>";
